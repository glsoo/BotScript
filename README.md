A ChatTriggers Module that allows users to create automatic bot systems, extremely easily, using commands! With custom chat criteria you can make any message responded with commands!
